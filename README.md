...
| 🧩 | **Партнёрские боты** | Партнёр создаёт своего бота (Telegram managed bots) прямо в боте и получает фиксированную комиссию (`PARTNER_COMMISSION_PERCENT`) с продаж; всё хостится у вас (multibot) |
